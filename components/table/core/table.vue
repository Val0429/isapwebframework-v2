                ...
                >
                    ...
                    >
                        ...
                        <select
                            ...
                            v-on:change="innatePageSize = $event.target.value"
                        >
                            <option
                                :key="key"
                                v-for="(value, key) in [5, 10, 25, 50, 100]"
                                :value="value"
                    ...
                    <div
                        ...
                        role="status"
                        aria-live="polite"
                    >{{ total && _("mb_ShowCurrentEntries", { curStart: currentStart, curEnd: currentEnd, total }) }}</div>
                </div>
            </div>
            <div class="col-sm-12 col-md-6">
                <b-pagination
                    align="right"
                    :total-rows="total"
                    :per-page="innatePageSize"
                    v-model="currentPage"
                    v-bind:prev-text="_('wb_PreviousPage')"
                    v-bind:next-text="_('wb_NextPage')"
                />
            </div>
        </div>
...
div.dataTables_wrapper {
    ...
    /deep/ .table-hover tbody tr.selected td,
